...
<head>
  ...
  <title>Politics</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-BmbxuPwQa2lc/FVzBcNJ7UAyJxM6wuqIj61tLrc4wSX0szH/Ev+nYRRuWlolflfl" crossorigin="anonymous">
  <style>
 .container{
    margin-top: 20px;
...
<a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="landing.php">      
      ...
      <span class="ml-3 text-xl">Newsopedia | Politics</span>
    </a>
    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
      ...
      <?php
        ...
        $api_url='https://newsapi.org/v2/everything?q="Politics"&apiKey=5e057beb78d34ec0b5d8399b03494c19';
